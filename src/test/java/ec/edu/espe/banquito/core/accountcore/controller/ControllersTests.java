package ec.edu.espe.banquito.core.accountcore.controller;
...
import ec.edu.espe.banquito.core.accountcore.dto.StaffLoginRequestDTO;
import ec.edu.espe.banquito.core.accountcore.dto.StaffLoginResponseDTO;
...
import ec.edu.espe.banquito.core.accountcore.repository.AccountSubtypeRepository;
import ec.edu.espe.banquito.core.accountcore.service.AccountQueryService;
import ec.edu.espe.banquito.core.accountcore.service.AccountTransactionService;
import ec.edu.espe.banquito.core.accountcore.service.CalendarQueryService;
import ec.edu.espe.banquito.core.accountcore.service.CoreUserAuthService;
...
class ControllersTests {
    ...
    void delegatesHolidayCheck() {
        ...
        CalendarController controller = new CalendarController(service, mock(ec.edu.espe.banquito.core.accountcore.service.AccountingDateService.class));
    ...
    void returnsCustomerAccountsAndBalance() {
        ...
        AccountController controller = new AccountController(subtypeRepository, queryService, transactionService, mock(ec.edu.espe.banquito.core.accountcore.service.AccountOpenService.class), mock(ec.edu.espe.banquito.core.accountcore.service.AccountStatusService.class), mock(ec.edu.espe.banquito.core.accountcore.service.ClearingPublisher.class));
        Account account = account();
        when(repository.findById(1L)).thenReturn(Optional.of(account));
        when(queryService.resolveAccount("1")).thenReturn(account);
        when(queryService.listAccountsByCustomer(1L)).thenReturn(List.of(
                new ec.edu.espe.banquito.core.accountcore.dto.AccountSummaryResponseDTO(
                        account.getId(), account.getAccountNumber(), account.getCustomerId(),
                        account.getStatus(), account.getAvailableBalance(), account.getAccountingBalance(),
                        "USD", account.getBranchId(), null, null)
        ));
